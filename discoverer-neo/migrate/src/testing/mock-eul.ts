    ...
    tables: {
      ...
      EUL4_EXPRESSIONS: [
        ...
        },
        {
          EXP_ID: 32,
          IT_OBJ_ID: 20,
          EXP_NAME: 'Cost Centre',
          EXP_DESCRIPTION: null,
          EXP_TYPE: 'CO',
          IT_EXT_COLUMN: 'COST_CENTRE',
          EXP_DATA_TYPE: 'VARCHAR2',
          IT_FORMAT_MASK: null,
          IT_HEADING: null,
          // Bound to the item class below — the pick-list case.
          IT_DOM_ID: 70,
        },
        {
          EXP_ID: 33,
          IT_OBJ_ID: 20,
          EXP_NAME: 'Cost Centre Sort',
          EXP_DESCRIPTION: null,
          EXP_TYPE: 'CO',
          IT_EXT_COLUMN: 'COST_CENTRE_SEQ',
          EXP_DATA_TYPE: 'NUMBER',
          IT_FORMAT_MASK: null,
          IT_HEADING: null,
          IT_DOM_ID: null,
      ...
      // One item class carrying all three capabilities: a LOV over
      // COST_CENTRE, ordered by COST_CENTRE_SEQ instead of alphabetically.
      EUL4_DOMAINS: [
        {
          DOM_ID: 70,
          DOM_NAME: 'Cost Centre',
          DOM_DESCRIPTION: 'Valid cost centres',
          DOM_DEVELOPER_KEY: 'CC_CLASS',
          DOM_IT_ID_LOV: 32,
          DOM_IT_ID_RANK: 33,
          DOM_CACHED: 1,
          DOM_CARDINALITY: 42,
