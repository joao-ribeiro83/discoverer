...
name: mode-migrate
description: |-
  Migrate mode for upgrading dependencies, migrating to new versions or stacks. Use when user requests version upgrades or stack migrations. Creates detailed migration plan with breaking changes, step-by-step execution, and rollback plan.
