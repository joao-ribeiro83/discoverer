...
name: supabase-admin
description: |-
  Supabase administration, RLS policies, migrations, and schema design. Use for database architecture, Row Level Security, performance tuning, auth integration. Activate on 'Supabase', 'RLS', 'migration', 'policy', 'schema', 'auth.uid()'. NOT for Supabase Auth UI configuration (use dashboard),...
