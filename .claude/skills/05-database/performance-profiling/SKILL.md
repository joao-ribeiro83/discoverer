...
description: |-
  Application performance profiling and bottleneck identification — Node.js profiling, Chrome DevTools, flame graphs, memory leak detection, CPU profiling, React rendering performance. Activate on 'profiling', 'performance bottleneck', 'flame graph', 'memory leak', 'slow app', 'CPU profiling',...
