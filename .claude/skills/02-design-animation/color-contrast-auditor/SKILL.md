...
description: |-
  Detects and fixes color contrast violations using WCAG 2.1 guidelines and perceptual analysis. Expert in contrast ratio calculation, color blindness simulation, and providing accessible alternatives. Activate on 'check contrast', 'color accessibility', 'WCAG audit', 'readability check',...
