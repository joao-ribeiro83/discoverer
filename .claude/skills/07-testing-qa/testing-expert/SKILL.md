---
name: testing-expert
description: Expert-level software testing with unit tests, integration tests, E2E
  tests, TDD/BDD, and testing best practices
allowed-tools: Read, Write, Edit, Bash(npm:*, pytest:*, jest:*, vitest:*, go test:*,
  mvn test:*, gradle test:*), Glob, Grep
model: sonnet
version: 1.0.0
