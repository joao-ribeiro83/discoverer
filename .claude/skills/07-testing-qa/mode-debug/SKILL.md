...
name: mode-debug
description: |-
  Debug mode for fixing bugs, errors, and crashes. Use when user reports bugs or errors that need fixing. Follows 5W1H approach: gather info, reproduce, analyze root cause, fix, and prevent recurrence.
