...
name: skill-logger
description: |-
  Logs and scores skill usage quality, tracking output effectiveness, user satisfaction signals, and improvement opportunities. Expert in skill analytics, quality metrics, feedback loops, and continuous improvement. Activate on 'skill logging', 'skill quality', 'skill analytics', 'skill scoring',...
