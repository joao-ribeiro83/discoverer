...
name: altium-365
description: |-
  Altium 365 Requirements and Systems Portal REST API for PCB requirements management. Use when user mentions 'Altium 365', 'Altium', 'PCB', 'EDA', 'Requirements Portal', or 'Systems Portal'.
