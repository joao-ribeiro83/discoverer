...
name: amplitude
description: |-
  Amplitude product analytics API. Use when user mentions 'Amplitude', 'product analytics', 'event export', 'funnel analysis', 'user retention', 'behavioral cohorts', or 'event ingestion'.
