...
description: |-
  When the user wants to plan, map, or restructure their website's page hierarchy, navigation, URL structure, or internal linking. Also use when the user mentions 'sitemap,' 'site map,' 'visual sitemap,' 'site structure,' 'page hierarchy,' 'information architecture,' 'IA,' 'navigation design,'...
