...
description: |-
  Git branching strategies, conflict resolution, rebase workflows, monorepo patterns, and advanced operations like cherry-pick, bisect, and reflog recovery. Activate on 'git', 'branching strategy', 'merge conflict', 'rebase', 'cherry-pick', 'monorepo git', 'git bisect', 'git reflog', 'squash...
