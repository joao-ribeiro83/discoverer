...
name: copywriting
description: |-
  Write and edit marketing copy for any channel — blogs, emails, social posts, landing pages, press releases, case studies, ads, and web pages. Trigger on requests for drafting content, writing headlines, crafting CTAs, SEO copywriting, email subject lines, social captions, or any persuasive...
