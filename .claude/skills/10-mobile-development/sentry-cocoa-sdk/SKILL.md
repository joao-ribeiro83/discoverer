...
description: |-
  Full Sentry SDK setup for Apple platforms (iOS, macOS, tvOS, watchOS, visionOS). Use when asked to 'add Sentry to iOS', 'add Sentry to Swift', 'install sentry-cocoa', or configure error monitoring, tracing, profiling, session replay, logging, or metrics for Apple applications. Supports SwiftUI...
