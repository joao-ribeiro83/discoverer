...
name: comment-mode
description: |-
  Granular feedback on drafts without rewriting. Generates highlighted HTML with click-to-reveal inline comments. Use when user says 'comment on this', 'leave comments on', 'give feedback on', or asks for feedback on a draft. Supports multiple lenses—editor feedback, POV simulation ('as brian...
