...
description: |-
  Expert in drone systems, computer vision, and autonomous navigation. Specializes in flight control, SLAM, object detection, sensor fusion, and path planning. Activate on 'drone', 'UAV', 'SLAM', 'visual odometry', 'PID control', 'MAVLink', 'Pixhawk', 'path planning', 'A*', 'RRT', 'EKF', 'sensor...
