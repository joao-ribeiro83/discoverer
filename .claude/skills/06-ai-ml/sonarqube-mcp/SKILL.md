...
name: sonarqube-mcp
description: |-
  Provides SonarQube and SonarCloud integration patterns via the Model Context Protocol (MCP) server. Enables quality gate monitoring, issue discovery and triaging, pre-push code analysis, and rule education directly in the agent workflow. Use when the user wants to check quality gates, search for...
allowed-tools: Read
model: opus
version: 1.0.0
category: 06-ai-ml
