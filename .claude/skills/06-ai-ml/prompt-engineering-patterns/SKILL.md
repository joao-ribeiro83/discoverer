...
description: |-
  This skill should be used when the user asks to 'optimize a prompt', 'improve prompt performance', 'design a prompt template', 'write better prompts', 'debug prompt issues', 'use chain-of-thought', 'structured prompting', 'few-shot prompting', or wants to apply advanced prompt engineering...
