...
description: |-
  Fan-out PR review across three parallel dimension agents (structural, security, devex/flag-hygiene), adversarially verify every finding, and synthesize a single prioritized verdict via an Opus judge. Use when asked for a full, comprehensive, or end-to-end review of a branch or PR — after...
